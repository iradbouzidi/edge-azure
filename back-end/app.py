...
def PUBLISH_USER(message):
    ...
    SharedAccessSignature = "SharedAccessSignature sr=MWIoTHub.azure-devices.net%2Fdevices%2Frpi-core%2Fmodules%2FBackEnd&sig=VPew8x1%2BylW5IJwjc6HOK1YbmYlADuyfZbGcOk1j7WI%3D&se=1637521273"
    ...
    client.username_pw_set(username=username, password=SharedAccessSignature)
